...
- Постоянный либо случайный выбор голоса.
...
- `voice_mode=static` — используются выбранные игроками голоса и голос по умолчанию.
- `voice_mode=random` — голоса назначаются случайно до перезагрузки NTTS.
